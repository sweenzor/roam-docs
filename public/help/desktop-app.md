...
- The desktop app is the full Roam in a standalone window, for Mac, Windows, and Linux. [[Install Roam]] covers the download.
- It's the same Roam as the browser version, plus a few things only an app can do.
