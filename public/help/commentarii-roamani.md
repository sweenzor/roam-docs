...
#### Commentarii Roamani: Roam Depot Gems: Mobile Extensions -- [[January 28th, 2026]]

- Hello Roamans! In this issue, we’re looking at a small set of extensions that help you customize the mobile experience to better match how you use Roam.
  - ![](https://embed.filekitcdn.com/e/vudzdYPdpXbwDanZpLkZZM/feyAnBQEcZKPz4WBHqUuQn/email)
- Roam’s mobile app is available on iOS and Android and lets you access your graph on the go. These extensions focus on simple gestures, extra buttons, and small interaction improvements that can make everyday actions smoother.
- ---

## Roam Depot Gems: Mobile Extensions

#### __Part I__

- Part one covers three extensions:
  - ​[Custom Mobile Buttons](https://github.com/8bitgentleman/roam-depot-mobile-bottombar) by [Matt Vogel](https://github.com/8bitgentleman)​
  - ​[Mobile Gesture Actions](https://github.com/mlava/mobile-gesture-actions) by [Mark Lavercombe](https://github.com/mlava)​
  - ​[Date UX Improvements](https://github.com/Stvad/roam-date) by [Vlad Sitalo](https://github.com/Stvad)​
- You can find all of these in the Roam Depot section inside your Roam Graph. To install them, simply click __Install.__

### Custom mobile buttons

- ![](https://embed.filekitcdn.com/e/vudzdYPdpXbwDanZpLkZZM/rUDHTiCKBNRqroGSnMDy5p/email)
- Custom Mobile Buttons adds configurable buttons to the bottom bar on mobile, giving you quick access to common actions like opening and closing blocks, triggering SmartBlock workflows, and formatting text.
  - ![](https://embed.filekitcdn.com/e/vudzdYPdpXbwDanZpLkZZM/i5kWmgtUvAx8d7vCBb9TY7/email)
    - __pick which buttons you want to add!__
- 
  - ![](https://embed.filekitcdn.com/e/vudzdYPdpXbwDanZpLkZZM/gtXNEDu8wFFz2yhopyREoZ/email)
    - __buttons in action!__
- A simple way to reduce friction for actions that are easy on desktop but sometimes clunky on mobile.

### Mobile gesture actions

- ![](https://embed.filekitcdn.com/e/vudzdYPdpXbwDanZpLkZZM/2kJksadFb4RRLKjgiqpnNp/email)
- Mobile Gesture Actions lets you map gestures like swipes, double taps, long presses, pinch, and rotate to Roam actions or keyboard shortcuts, such as navigating daily notes, opening sidebars, undo/redo, or opening the command palette.
  - ![](https://embed.filekitcdn.com/e/vudzdYPdpXbwDanZpLkZZM/924hjBo8KfuWogWLdriCuF/email)
    - __we set the settings to opening the command palette when long pressing__
- 
  - ![](https://embed.filekitcdn.com/e/vudzdYPdpXbwDanZpLkZZM/rAHGgTakvtNSpNLQTNPSDD/email)
    - ____long press____
- Especially useful on mobile, where it lets you navigate without relying on menus or precise taps.

### Date UX Improvements

- ![](https://embed.filekitcdn.com/e/vudzdYPdpXbwDanZpLkZZM/xaKKd6FQ8FPhqvxHb3qHZk/email)
- This extension enhances daily page workflows in Roam by adding a date widget next to date links. Use it to quickly adjust dates, navigate between daily notes, or create new daily pages using natural language.
  - ![](https://embed.filekitcdn.com/e/vudzdYPdpXbwDanZpLkZZM/iopQHY7wyEip2vK3ZYpsoy/email)
    - __here's an example of how it works!__
- ---

### Change Log 🪵 🌱

- A few new extensions were added to Roam Depot recently. We didn’t cover them in depth in this issue, but they’re on our radar and we're excited to explore them in upcoming newsletters:
  - ​[Better Command Palette](https://github.com/mlava/better-command-palette) by [Mark Lavercombe](https://github.com/mlava)​
  - ​[Better Bullets](https://github.com/mlava/better-bullets) by [Mark Lavercombe](https://github.com/mlava)​
- In future issues, we’ll also take a look at the very exciting new features and updates added to [Roam Reader](https://chromewebstore.google.com/detail/kghmbkhikifcnkjoakokkhdkfdhieonb?utm_source=item-share-cb) (if you haven't already, check out our newsletter on it [here](https://roam-research.kit.com/posts/commentarii-roamani-roam-reader?_gl=1*2239cy*_gcl_aw*R0NMLjE3NjQyNTc1MDEuQ2owS0NRaUFpcURKQmhDWEFSSXNBQmsya1NsRmM3bVptV01GWEFRdE5QM2tJeGZzQXBHN0hlRHhoeE1EeXNHWDBndy1rb0xhd2QyLUxsVWFBdWotRUFMd193Y0I.*_gcl_au*MTYzMzUzNTg0LjE3NjcxMzA5NzUuNTk2ODYzNjA5LjE3NjgwODE0NTQuMTc2ODA4Mjk2MQ..)!)
- ---
- [Join](https://join.slack.com/t/roamresearch/shared_invite/zt-3n31y81xe-PVYEXT6rOmkT0f3oxWyTYA) our slack channel here, and don't forget to check out [the Roam help graph](https://roamresearch.com/#/app/help/page/Ec97klr7x) for updates!
  - ![Picture of the penguin who went neither side %28To the feeding ground or to  the edge of the ice%29 : r/interesting](https://i.redd.it/u6s6wqfr5geg1.png)
