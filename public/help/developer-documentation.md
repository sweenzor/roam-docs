...
- **Some starting points**
  - [[Roam Alpha API]]: [Docs Link](https://roamresearch.com/#/app/developer-documentation/page/tIaOPdXCj)
    - This is the API that frontend Roam extensions use
  - Building a [[Roam Depot]] extension: [Docs Link](https://roamresearch.com/#/app/developer-documentation/page/5BB8h4I7b)
    - Covers code guidelines, developing locally, and submitting your extension to the marketplace.
  - [[Roam Backend API]]: [Docs Link](https://roamresearch.com/#/app/developer-documentation/page/W4Po8pcHQ)
  ...
  - [[Roam Append API]]: [Docs Link](https://roamresearch.com/#/app/developer-documentation/page/eb8OVhaFC)
