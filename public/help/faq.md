...
#### **Does Roam have a [[Dark Mode]], and how do I enable it?**

- Roam Depot Extensions
  - [[CSS Dark Mode Toggle]] by [[Matt Vogel]] adds a button to the topbar to toggle a theme's dark mode manually. Here's how to enable it:
    - ![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fhelp%2FX19XTdGE53.gif?alt=media&token=6b294eef-e5eb-4c6c-a739-91a7c4566f56)
  - [[Blueprint]] by [[Alexander Rink]] offers light and dark theme for Roam Research based on blueprint.js. Here's how to enable it:
    - ![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fhelp%2F60uLtuv8Iq.gif?alt=media&token=2405c2de-8d01-4df3-8e24-8cd3e8b899d7)
  - [[Roam "Native" Dark]] by [[hyc]]. Here's how to enable it:
    - ![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fhelp%2F62RroyZD-b.gif?alt=media&token=d845b444-404f-4dd2-99a8-539657a83cea)
- [Graphs and Settings/All Graphs](https://roamresearch.com/#/app) page
  - Only applies outside graphs while switching graphs, billing etc.
  - Go to the [Graphs and Settings/All Graphs](https://roamresearch.com/#/app) > Click on your photo > Theme > Dark
    - ![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fhelp%2FE_WCiEAWni.gif?alt=media&token=105e780f-619c-41a0-a8ea-3d2efe47cf98)
- Mobile App
...
#### **Can I [export]([[Export]]) a Roam page to [PDF]([[pdf]]), Word (.docx), or EPUB format?**

- The Export or Import Document extension by Mark Lavercombe, available on Roam Depot, allows you to export a page (not the whole graph) in your graph into many different formats. Here's how to do that-
  - Install **Export or Import Document** by Mark Lavercombe from Roam Depot
  - Go to the page you want to export
  - Press Ctrl+p and search for export
  - Select Export as PDF or DOCS
    ![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fhelp%2FG-HF77i2mH.gif?alt=media&token=6f4eeeed-3eff-408f-b9e2-b793e58b7fe3)

#### **Can I pull [[Weather Report]] or a daily [[Weather Summary]] into my Roam Daily Notes?**

- You can try the[ Weathercards](https://github.com/mlava/weathercards) extension by Mark Lavercombe, available on Roam Depot, which imports weather conditions and forecasts from Open Weather Map. You can update the location and number of days from the settings.
  - ![](https://firebasestorage.googleapis.com/v0/b/firescript-577a2.appspot.com/o/imgs%2Fapp%2Fhelp%2FKcOChggtjb.gif?alt=media&token=26c1e0fe-8292-4764-bc8f-9ed26d529cc8)
